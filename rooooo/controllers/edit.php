...
class Edit extends CI_Controller {
    ...
    public function getDogOptions() {
        ...
        if (count($dogNames) > 0) {
            ...
            $html .= '<div class="text-center"><select id="dog_names" onchange="editMeals();">';
            ...
            $html .= '</select>';
            $html .= '<input type="button" onclick="editMeals();" value="Choose Dog" /></div>';
        }
        return $html;
    }
